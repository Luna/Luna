    ...
    size: {
      ...
      hero: {
        base: TEXT_STYLE({
          ...
          color: 'custom',
          weight: 'semibold',
          className: 'aspect-square flex h-16 px-[24px]',
        }),
        text: 'mx-[1.5em]',
      },
      large: {
        base: TEXT_STYLE({
          ...
          color: 'custom',
          weight: 'semibold',
          className: 'aspect-square flex h-9 px-[11px]',
        }),
        content: 'gap-2',
        icon: '-mb-0.5 h-4 w-4',
      ...
      medium: {
        base: TEXT_STYLE({
          ...
          color: 'custom',
          weight: 'semibold',
          className: 'aspect-square flex h-8 px-[7px]',
        }),
        icon: '-mb-0.5 h-4 w-4',
        content: 'gap-2',
      ...
      small: {
        base: TEXT_STYLE({
          ...
          color: 'custom',
          weight: 'medium',
          className: 'aspect-square flex h-7 px-[5px]',
        }),
      ...
      xsmall: {
        base: TEXT_STYLE({
          ...
          color: 'custom',
          weight: 'medium',
          className: 'aspect-square flex h-6 px-[5px]',
        }),
        icon: '-mb-0.5 h-3 w-3',
        content: 'gap-1',
      ...
      xxsmall: {
        base: TEXT_STYLE({
          variant: 'body',
          color: 'custom',
          className: 'aspect-square flex h-5 px-[3px] leading-[16px]',
        }),
        content: 'gap-0.5',
        icon: 'mb-[-0.1cap]',
        extraClickZone: 'after:inset-[-12px]',
