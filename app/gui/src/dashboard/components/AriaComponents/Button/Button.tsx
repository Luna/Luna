...
import type { ButtonProps, ButtonRenderProps } from './types'
...
export const Button = memo(
  forwardRef(function Button(props: ButtonProps, ref: ForwardedRef<HTMLButtonElement>) {
    ...
    const shouldDisplayBorder = isJoined === true && (position === 'first' || position === 'middle')
    ...
    const button = (
      ...
      >
        {(render: aria.ButtonRenderProps | aria.LinkRenderProps) => {
          // This is unsafe, but it's a performance optimization
          // eslint-disable-next-line no-restricted-syntax
          unsafeWriteValue(render as ButtonRenderProps, 'isLoading', isLoading)
