...
lazy val `akka-wrapper` = project
  ...
  .settings(
    ...
    libraryDependencies ++= akka ++ scalaLibrary ++ scalaCompiler ++ Seq(
      Dependencies.Compile.scalaParserCombinators,
      Dependencies.Compile.scalaJava8Compat,
      Dependencies.Compile.akkaHttp,
      Dependencies.Compile.akkaHttpCore,
      Dependencies.Compile.akkaSlf4j,
      Dependencies.Compile.akkaParsing,
      Dependencies.Compile.akkaProtobufV3,
      ...
      Dependencies.Compile.jline,
      Dependencies.Compile.jna,
      Dependencies.Compile.sprayJson,
    ),
...
lazy val `runtime-test-instruments` =
  (project in file("engine/runtime-test-instruments"))
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        Dependencies.Compile.graalvmPolyglotTck,
        Dependencies.Compile.graalvmTruffleTck,
        Dependencies.Compile.graalvmTruffleTckCommon,
        Dependencies.Compile.graalvmTruffleTckTests,
        Dependencies.Compile.openideUtilLookup % "provided",
      ),
