...
import org.enso.interpreter.node.expression.builtin.resource.Managed_Resource;
...
public final class Builtins {
  ...
  public Builtins(EnsoContext context) {
    ...
    managedResource = builtins.get(Managed_Resource.class);
    ...
    dateTime = builtins.get(org.enso.interpreter.node.expression.builtin.date.Date_Time.class);
    duration = builtins.get(org.enso.interpreter.node.expression.builtin.date.Duration.class);
    timeOfDay = builtins.get(org.enso.interpreter.node.expression.builtin.date.Time_Of_Day.class);
    timeZone = builtins.get(org.enso.interpreter.node.expression.builtin.date.Time_Zone.class);
