...
public class EnsoServiceLoader<T extends EnsoService> {
  ...
  public EnsoServiceLoader(Class<T> clazz) {
   ...
   * <p>
   * The predicate should uniquely identify a single service, thus if it matches more than one entry it is considered an error - it should only happen if two libraries mistakenly provide a clashing service name and cannot be distinguished.
   */
